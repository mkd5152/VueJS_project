<template>
  <div class="container">
    ...
    >
      ...
      <div
        class="card-body p-1"
        v-for="post in posts.assigned_orders"
        ...
        <div class="p-0 mb-0 bg-white text-dark rounded">
          <div class="p-2 mb-0 bg-white text-dark rounded">
            <div class="d-flex justify-content-between">
              ...
              <div class="p-0 small">TO PICKUP</div>
            </div>
            <div class="d-flex justify-content-between">
...
export default {
  ...
  created() {
    axios
      .get(
        "https://api.stagingtahmeelapp.com/technical_interview/orders/assigned"
      )
      .then((posts) => {
        console.log(posts.data);
        this.posts = posts.data;
        this.length = posts.data.assigned_orders.length;
      });
  },
    methods: {
    switchImage() {
